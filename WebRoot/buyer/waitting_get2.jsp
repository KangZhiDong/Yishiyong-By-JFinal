...
<div id="header">
  ...
  <div class="nav">
    <ul>
      ...
      <!--试客登录-->
      <li style="float:right;"><a href="/buyer/award" class="nav-img">继续申请(1)</a></li>
        ...
        <div class="bd-cc-r">
          <div class="bbs-r clearfix">
            ...
            <div>
              ...
              <div class="file-box inp border_line">
                第三步.将已评价的内容，发布在琳琅
                <span class="fr cor_green">已评价，待商家审核</span>
                <br><br>
                好评内容：<br><br>
                <p class="lh150">很不错，物流快，还会再来</p>
              </div>
